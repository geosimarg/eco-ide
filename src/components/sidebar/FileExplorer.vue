<script setup lang="ts">
  ...
  import type { FileEntry } from '@/interfaces/file_entry';
  import type { ContextMenuItem } from '@/interfaces/context_menu_item';
...
<template>
  <div class="file-explorer" :class="{ 'drag-over': isDragOver }" @dragenter="handleDragEnter"
