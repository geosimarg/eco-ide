<script setup lang="ts">
    ...
    import { SettingsSubTab, SettingsTab } from '@/types/settings_tab';
    ...
    const activeTab = ref<SettingsTab>('user');
    const subTab = ref<SettingsSubTab>('appearance');
            ...
            <div class="settings-header">
                ...
                <div class="header-tabs">
                    ...
                    <button :class="{ active: activeTab === 'workspace' }" @click="activeTab = 'workspace'"
                        :disabled="!configStore.workspacePath">Workspace</button>
                </div>
            </div>

            <div class="settings-body">
                <div class="settings-nav">
                    <button v-for="item in sidebarItems" :key="item.id" :class="{ active: subTab === item.id }"
                        @click="subTab = item.id as SettingsSubTab">
                    ...
                    <div v-if="subTab === 'files'" class="settings-section">
                        ...
                        <div class="form-group">
                            ...
                            <div class="list-input">
                                <input v-model="hiddenFileInput" placeholder="*.log, *.tmp"
                                    @keyup.enter="addHiddenFile" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="list-input">
                                <input v-model="hiddenFolderInput" placeholder="node_modules, .git"
