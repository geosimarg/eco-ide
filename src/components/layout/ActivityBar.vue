...
<template>
  <div class="activity-bar">
    <div class="top-icons">
      ...
      >
        <!-- Files Icon -->
        <svg v-if="view.icon === 'files'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <!-- Search Icon -->
        <svg v-else-if="view.icon === 'search'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
          <circle cx="11" cy="11" r="6" />
          <path d="M21 21L15.5 15.5" />
        </svg>
        
        <!-- Git Icon -->
        <svg v-else-if="view.icon === 'git'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <!-- Extensions Icon -->
        <svg v-else-if="view.icon === 'extensions'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
