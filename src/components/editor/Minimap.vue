<script setup lang="ts">
  import { MinimapLineData } from '@/interfaces/minimap_line_data';
...
<template>
  <div ref="minimapContainer" class="minimap" @click="handleMinimapClick" @mousedown="handleMinimapDrag">
    <div class="minimap-content" :style="{ height: `${totalHeight}%` }">
      <div v-for="line in lines" :key="line.lineNumber" class="minimap-line" :style="{
        top: `${line.y}%`,
        height: `${line.height}%`
      }" />
    </div>
