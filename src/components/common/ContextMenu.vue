    ...
    <Teleport to="body">
        <div v-if="visible" ref="menuRef" class="context-menu"
            ...
            <template v-for="item in items" :key="item.id">
                ...
                <div v-else class="menu-item-wrapper" @mouseenter="handleMouseEnter(item)"
                    @mouseleave="handleMouseLeave">
                    <div class="menu-item" :class="{ disabled: item.disabled, 'has-children': item.children?.length }"
                    ...
                    <div v-if="item.children?.length && hoveredItem === item.id" class="submenu">
                        <template v-for="child in item.children" :key="child.id">
                            ...
                            <div v-else class="menu-item" :class="{ disabled: child.disabled }"
